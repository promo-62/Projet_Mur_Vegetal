...
// Returns the list of Event objects contained in the server
  ...
  static deleteEvent(String id){
    http.delete(Global.url + Global.eventsURL + "/" + id, 
      headers: {
      HttpHeaders.authorizationHeader: Global.authentificationID,
      HttpHeaders.userAgentHeader: "Mozilla"
      }
  ...
  static deleteCountdown(String id){
    http.delete(Global.url + Global.countdownsURL + "/" + id, 
      headers: {
      HttpHeaders.authorizationHeader: Global.authentificationID,
      HttpHeaders.userAgentHeader: "Mozilla"
      }
  ...
  static deleteMedia(String id){
    http.delete(Global.url + Global.mediasURL + "/" + id, 
      headers: {
      HttpHeaders.authorizationHeader: Global.authentificationID,
      HttpHeaders.userAgentHeader: "Mozilla"
      }
